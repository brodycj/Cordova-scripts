...
#
# Script to create a new Cordova/PhoneGap project from the Cordova Template.
# 	You need to install Cordova/PhoneGapLib first (through the installer) 
#	before this script can work.
#
# Make sure you set the executable bit on this script, if it is not preserved by git.
